resource "azuread_privileged_access_group_assignment_schedule" "privileged_access_group_assignment_schedules" {
  for_each = var.privileged_access_group_assignment_schedules
