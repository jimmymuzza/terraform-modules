resource "aws_sagemaker_domain" "sagemaker_domains" {
  for_each = var.sagemaker_domains
  ...
  tag_propagation               = each.value.tag_propagation
  tags                          = each.value.tags
  tags_all                      = each.value.tags_all

  dynamic "default_space_settings" {
    for_each = each.value.default_space_settings != null ? each.value.default_space_settings : []
    content {
  ...
  dynamic "default_user_settings" {
    for_each = each.value.default_user_settings != null ? each.value.default_user_settings : []
    content {
  ...
  dynamic "domain_settings" {
    for_each = each.value.domain_settings != null ? each.value.domain_settings : []
    content {
