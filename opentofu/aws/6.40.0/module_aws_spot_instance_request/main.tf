resource "aws_spot_instance_request" "spot_instance_requests" {
  for_each = var.spot_instance_requests
  ...
  instance_interruption_behavior       = each.value.instance_interruption_behavior
  instance_type                        = each.value.instance_type
  ipv6_address_count                   = each.value.ipv6_address_count
  ipv6_addresses                       = each.value.ipv6_addresses
  key_name                             = each.value.key_name
  launch_group                         = each.value.launch_group
