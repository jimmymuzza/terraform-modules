resource "aws_sagemaker_endpoint_configuration" "sagemaker_endpoint_configurations" {
  for_each = var.sagemaker_endpoint_configurations
  ...
  dynamic "async_inference_config" {
    for_each = each.value.async_inference_config != null ? each.value.async_inference_config : []
    content {
      ...
      dynamic "output_config" {
        for_each = async_inference_config.value.output_config != null ? async_inference_config.value.output_config : []
        content {
  ...
  dynamic "data_capture_config" {
    for_each = each.value.data_capture_config != null ? each.value.data_capture_config : []
    content {
      ...
      dynamic "capture_options" {
        for_each = data_capture_config.value.capture_options != null ? data_capture_config.value.capture_options : []
        content {
  ...
  dynamic "production_variants" {
    for_each = each.value.production_variants != null ? each.value.production_variants : []
    content {
      ...
      dynamic "capacity_reservation_config" {
        for_each = production_variants.value.capacity_reservation_config != null ? production_variants.value.capacity_reservation_config : []
        content {
          capacity_reservation_preference = capacity_reservation_config.value.capacity_reservation_preference
          ml_reservation_arn              = capacity_reservation_config.value.ml_reservation_arn
        }
      }
  ...
  dynamic "shadow_production_variants" {
    for_each = each.value.shadow_production_variants != null ? each.value.shadow_production_variants : []
    content {
      ...
      dynamic "capacity_reservation_config" {
        for_each = shadow_production_variants.value.capacity_reservation_config != null ? shadow_production_variants.value.capacity_reservation_config : []
        content {
          capacity_reservation_preference = capacity_reservation_config.value.capacity_reservation_preference
          ml_reservation_arn              = capacity_reservation_config.value.ml_reservation_arn
        }
