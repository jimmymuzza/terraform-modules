resource "aws_cognito_risk_configuration" "cognito_risk_configurations" {
  for_each = var.cognito_risk_configurations
  ...
  dynamic "account_takeover_risk_configuration" {
    for_each = each.value.account_takeover_risk_configuration != null ? each.value.account_takeover_risk_configuration : []
    content {

      dynamic "actions" {
        for_each = account_takeover_risk_configuration.value.actions != null ? account_takeover_risk_configuration.value.actions : []
        content {
  ...
  dynamic "compromised_credentials_risk_configuration" {
    for_each = each.value.compromised_credentials_risk_configuration != null ? each.value.compromised_credentials_risk_configuration : []
    content {
      event_filter = compromised_credentials_risk_configuration.value.event_filter

      dynamic "actions" {
        for_each = compromised_credentials_risk_configuration.value.actions != null ? compromised_credentials_risk_configuration.value.actions : []
        content {
  ...
  dynamic "risk_exception_configuration" {
    for_each = each.value.risk_exception_configuration != null ? each.value.risk_exception_configuration : []
    content {
