resource "aws_bedrockagentcore_harness" "bedrockagentcore_harnesses" {
  ...
  dynamic "environment" {
    ...
    content {
      ...
      dynamic "agentcore_runtime_environment" {
        for_each = environment.value.agentcore_runtime_environment != null ? environment.value.agentcore_runtime_environment : []
        content {
          lifecycle_configuration = agentcore_runtime_environment.value.lifecycle_configuration

          dynamic "filesystem_configuration" {
            for_each = agentcore_runtime_environment.value.filesystem_configuration != null ? agentcore_runtime_environment.value.filesystem_configuration : []
            content {
          ...
          dynamic "network_configuration" {
            for_each = agentcore_runtime_environment.value.network_configuration != null ? agentcore_runtime_environment.value.network_configuration : []
            content {
