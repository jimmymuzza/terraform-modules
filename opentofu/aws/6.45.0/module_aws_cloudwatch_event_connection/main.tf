  ...
  dynamic "auth_parameters" {
    ...
    content {
      ...
      dynamic "connectivity_parameters" {
        for_each = auth_parameters.value.connectivity_parameters != null ? auth_parameters.value.connectivity_parameters : []
        content {

          dynamic "resource_parameters" {
            for_each = connectivity_parameters.value.resource_parameters != null ? connectivity_parameters.value.resource_parameters : []
            content {
