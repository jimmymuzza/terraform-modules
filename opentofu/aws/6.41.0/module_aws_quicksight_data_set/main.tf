resource "aws_quicksight_data_set" "quicksight_data_sets" {
        ...
        content {
          ...
          dynamic "create_columns_operation" {
            ...
            content {
              ...
              dynamic "columns" {
                for_each = create_columns_operation.value.columns != null ? create_columns_operation.value.columns : []
                content {
    ...
    content {
      ...
      dynamic "relational_table" {
        ...
        content {
          ...
          dynamic "input_columns" {
            for_each = relational_table.value.input_columns != null ? relational_table.value.input_columns : []
            content {
      ...
      dynamic "s3_source" {
        ...
        content {
          ...
          dynamic "input_columns" {
            for_each = s3_source.value.input_columns != null ? s3_source.value.input_columns : []
            content {
              name = input_columns.value.name
              type = input_columns.value.type
            }
  ...
  dynamic "row_level_permission_tag_configuration" {
    ...
    content {
      ...
      dynamic "tag_rules" {
        for_each = row_level_permission_tag_configuration.value.tag_rules != null ? row_level_permission_tag_configuration.value.tag_rules : []
        content {
