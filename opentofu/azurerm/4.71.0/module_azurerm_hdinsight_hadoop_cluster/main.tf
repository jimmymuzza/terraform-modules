resource "azurerm_hdinsight_hadoop_cluster" "hdinsight_hadoop_clusters" {
  for_each = var.hdinsight_hadoop_clusters
  ...
  dynamic "roles" {
    ...
    content {
      ...
      dynamic "edge_node" {
        for_each = roles.value.edge_node != null ? roles.value.edge_node : []
        content {
          ...
          dynamic "https_endpoints" {
            ...
            content {
              ...
              disable_gateway_auth = https_endpoints.value.disable_gateway_auth
              private_ip_address   = https_endpoints.value.private_ip_address
              sub_domain_suffix    = https_endpoints.value.sub_domain_suffix
            }
          }

          dynamic "install_script_action" {
            for_each = edge_node.value.install_script_action != null ? edge_node.value.install_script_action : []
            content {
          ...
          dynamic "uninstall_script_actions" {
            ...
            content {
              ...
              uri        = uninstall_script_actions.value.uri
