resource "azurerm_linux_function_app_slot" "linux_function_app_slots" {
  for_each = var.linux_function_app_slots
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      minimum_tls_cipher_suite                      = site_config.value.minimum_tls_cipher_suite
