resource "azurerm_system_center_virtual_machine_manager_cloud" "system_center_virtual_machine_manager_clouds" {
  for_each = var.system_center_virtual_machine_manager_clouds
