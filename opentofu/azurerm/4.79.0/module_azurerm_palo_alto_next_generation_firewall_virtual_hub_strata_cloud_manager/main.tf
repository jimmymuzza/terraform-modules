resource "azurerm_palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager" "palo_alto_next_generation_firewall_virtual_hub_strata_cloud_managers" {
  for_each = var.palo_alto_next_generation_firewall_virtual_hub_strata_cloud_managers
