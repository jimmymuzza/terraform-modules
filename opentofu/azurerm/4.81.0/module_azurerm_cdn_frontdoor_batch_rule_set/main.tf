resource "azurerm_cdn_frontdoor_batch_rule_set" "cdn_frontdoor_batch_rule_sets" {
  for_each = var.cdn_frontdoor_batch_rule_sets
  ...
  dynamic "rule" {
    ...
    content {
      ...
      behaviour_on_match = rule.value.behaviour_on_match
